...
export const FETCH_PHONE_BY_ID_START = 'FETCH_PHONE_START'
export const FETCH_PHONE_BY_ID_SUCCESS = 'FETCH_PHONE_SUCCESS'
export const FETCH_PHONE_BY_ID_FAILURE = 'FETCH_PHONE_FAILURE'
